...
- [ ] [high] [TEEPER-43] Create automated tests for DB-backed OAuth session token persistence https://linear.app/teemo-personal-projects/issue/TEEPER-43 (`main`)
- [ ] [high] [TEEPER-44] Verify and validate deploy.sh / promote.sh scripts end-to-end https://linear.app/teemo-personal-projects/issue/TEEPER-44 (`main`)
...
- [ ] [medium] [TEEPER-45] Add monitoring/alerting for Celery beat scheduler health https://linear.app/teemo-personal-projects/issue/TEEPER-45 (`main`)
- [ ] [medium] [TEEPER-45] Set up logging and monitoring for Celery beat scheduler https://linear.app/teemo-personal-projects/issue/TEEPER-45 (`main`)
- [ ] [medium] [TEEPER-46] Test enhanced email processing pipeline with real email data https://linear.app/teemo-personal-projects/issue/TEEPER-46 (`main`)
...
- [ ] [medium] [TEEPER-40] Fix add-email modal overflow — long lists pushed off screen https://linear.app/teemo-personal-projects/issue/TEEPER-40 (`main`)
- [ ] [low] Consider merging ui-overhaul to main once testing is complete (`ui-overhaul`)
- [ ] [low] [TEEPER-47] Document OAuth persistence changes and 3AM digest schedule https://linear.app/teemo-personal-projects/issue/TEEPER-47 (`main`)
- [ ] [low] Test the Claude Code plan label persistence bug reproduction steps and document the workaround (`main`)
- [ ] [low] [TEEPER-48] Document rm-rf-and-redeploy strategy in deployment docs https://linear.app/teemo-personal-projects/issue/TEEPER-48 (`main`)
- [ ] [low] [TEEPER-41] Pull sender favicon/icon from email to indicate source, persist to DB https://linear.app/teemo-personal-projects/issue/TEEPER-41 (`main`)
- [ ] [low] [TEEPER-42] Add archive/folder action in profile/settings to keep inbox clean https://linear.app/teemo-personal-projects/issue/TEEPER-42 (`main`)
